...
| `GET`<br/>`/periodic-payments/{paymentProduct}/{paymentId}/authorisations`                          | _removed from PIS_                                                                                                        | moved to [signing](https://developer.sebgroup.com/products/signing/signing) product |
| `POST`<br/>`/periodic-payments/{paymentProduct}/{paymentId}/authorisations`                         | In prod environment it was removed from PIS <br/><br>In Sandbox use: <br/> `POST`<br/>`/signing-orders`                   | moved to [signing](https://developer.sebgroup.com/products/signing/signing) product |
| `GET`<br/>`/periodic-payments/{paymentProduct}/{paymentId}/authorisations/`<br/>`{authorisationId}` | In prod environment it was removed from PIS <br/><br>In Sandbox use: <br/> `GET`<br/>`/signing-orders/{authorisationId}`  | moved to [signing](https://developer.sebgroup.com/products/signing/signing) product |
